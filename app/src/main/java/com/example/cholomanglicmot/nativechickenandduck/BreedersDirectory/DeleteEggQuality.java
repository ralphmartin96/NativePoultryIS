...
public class DeleteEggQuality extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_delete_egg_quality, container, false);


        final Integer feeding_id = getArguments().getInt("Breeder Hatchery ID");
        context = getActivity();
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isDeleted = myDb.deleteEggQuality(feeding_id);
                if(isNetworkAvailable()){
                    ...
                    API_deleteEggQuality(requestParams);
                }
                if(isDeleted){
                    Toast.makeText(getActivity(), "Succesfully deleted egg quality record", Toast.LENGTH_SHORT).show();
                    getDialog().dismiss();
    ...
    private void API_deleteEggQuality(RequestParams requestParams){
        APIHelperAsync.deleteEggQuality("deleteEggQuality", requestParams, new BaseJsonHttpResponseHandler<Object>() {
            @Override
