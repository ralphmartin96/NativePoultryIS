...
public class DeleteFeedingDialogBreeder extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final Integer feeding_id = getArguments().getInt("Breeder Feeding ID");
        context = getActivity();
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isDeleted = myDb.deleteFeedingRecordBreeder(feeding_id);
                if(isNetworkAvailable()){
                    ...
                    API_deleteBreederFeedingRecord(requestParams);
                }
                if(isDeleted){
    ...
    private void API_deleteBreederFeedingRecord(RequestParams requestParams){
        APIHelperAsync.deleteBreederFeedingRecord("deleteBreederFeedingRecord", requestParams, new BaseJsonHttpResponseHandler<Object>() {
            @Override
