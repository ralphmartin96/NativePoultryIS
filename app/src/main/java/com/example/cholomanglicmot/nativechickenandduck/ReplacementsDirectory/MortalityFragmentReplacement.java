 ...
 */
public class MortalityFragmentReplacement extends Fragment {
    ...
    public MortalityFragmentReplacement() {
            ...
            public void onClick(View view) {
                ...
                if(!date_died.getText().toString().isEmpty() && (!male_death.getText().toString().isEmpty() || !female_death.getText().toString().isEmpty() || !total_death.getText().toString().isEmpty()) && !reason.getSelectedItem().toString().isEmpty()){
                    ...
                    if(sexingDone){
                        ...
                        isInserted = myDb.insertDataMortalityAndSales(date_died.getText().toString(),null,breeder_id,null, "replacement", "died", null,null, null,Integer.parseInt(total_death.getText().toString()),reason.getSelectedItem().toString(), remarks.getText().toString(), null );
                        ...
                        boolean isBreederInvUpdated = myDb.updateMaleFemaleReplacementCount2(breeder_tag, current_male_count,current_female_count, new_total_count);
                    ...
                    if(isInserted){
                        Toast.makeText(getActivity(),"Database updated", Toast.LENGTH_SHORT).show();
                         Intent intent_line = new Intent(getActivity(), MortalityAndSalesRecordsReplacement.class);
