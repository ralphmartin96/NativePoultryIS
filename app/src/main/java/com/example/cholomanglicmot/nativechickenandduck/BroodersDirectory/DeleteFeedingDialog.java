...
public class DeleteFeedingDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isDeleted = myDb.deleteFeedingRecord(feeding_id);
                if(isNetworkAvailable()){
                    ...
                    API_deleteBrooderFeedingRecord(requestParams);
                }
                if(isDeleted){
    ...
    private void API_deleteBrooderFeedingRecord(RequestParams requestParams){
        APIHelperAsync.deleteBrooderFeedingRecord("deleteBrooderFeedingRecord", requestParams, new BaseJsonHttpResponseHandler<Object>() {
            @Override
