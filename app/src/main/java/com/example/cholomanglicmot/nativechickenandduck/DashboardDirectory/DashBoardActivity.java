...
//        }
    ...
    private void getSizes() {
        Log.d(debugTag, "Pen size: " + myDb.getPensSize());
        Log.d(debugTag, "Generation size: " + myDb.getGenerationSize());
        Log.d(debugTag, "Line size: " + myDb.getLineSize());
        Log.d(debugTag, "Family size: " + myDb.getFamilySize());
        Log.d(debugTag, "Family for Display size: " + myDb.getFamilyForDisplaySize());
        Log.d(debugTag, "Brooder size: " + myDb.getBroodersSize());
        Log.d(debugTag, "Brooder Inventory size: " + myDb.getBroodersInventorySize());
        Log.d(debugTag, "Breeder size: " + myDb.getBreederSize());
        Log.d(debugTag, "Breeder Inventory size: " + myDb.getBreederInventorySize());
        Log.d(debugTag, "Replacement size: " + myDb.getReplacementSize());
        Log.d(debugTag, "Replacement Inventory size: " + myDb.getReplacementInventorySize());

        Log.d(debugTag, "Brooder Feeding size: " + myDb.getBroodersFeedingSize());
        Log.d(debugTag, "Brooder Growth size: " + myDb.getBroodersGrowthSize());

        Log.d(debugTag, "Breeder Feeding size: " + myDb.getBreederFeedingSize());
        Log.d(debugTag, "Breeder Egg Production size: " + myDb.getEggProductionSize());
        Log.d(debugTag, "Breeder Hatchery size: " + myDb.getHatcherySize());
        Log.d(debugTag, "Breeder Egg Quality size: " + myDb.getEggQualitySize());

        Log.d(debugTag, "Brooder Feeding size: " + myDb.getReplacementFeedingSize());
        Log.d(debugTag, "Brooder Growth size: " + myDb.getReplacementGrowthSize());

        Log.d(debugTag, "PhenoMorphos size: " + myDb.getPhenoMorphosSize());
        Log.d(debugTag, "PhenoMorpho Values size: " + myDb.getPhenoMorphoValuesSize());

        Log.d(debugTag, "Mortality & Sales size: " + myDb.getMortalitySalesSize());
    }
...
//        APIHelperAsync.getFarmInfo("getFarmInfo/"+farm_id, new BaseJsonHttpResponseHandler<Object>() {
//            @Override
//            public void onSuccess(int statusCode, Header[] headers, String rawJsonResponse, Object response){
//
//
...
//        APIHelperAsync.getFamily("getFamilyForDisplay/"+farm_id, new BaseJsonHttpResponseHandler<Object>() {
//            @Override
//            public void onSuccess(int statusCode, Header[] headers, String rawJsonResponse, Object response){
//
//                Gson gson = new Gson();
...
//        APIHelperAsync.getBreederFeeding("getBreederFeeding?page=3", new BaseJsonHttpResponseHandler<Object>() {
//            @Override
//            public void onSuccess(int statusCode, Header[] headers, String rawJsonResponse, Object response){
//
//                Gson gson = new Gson();
...
//        APIHelperAsync.getEggProduction("getEggProduction/", new BaseJsonHttpResponseHandler<Object>() {
//            @Override
//            public void onSuccess(int statusCode, Header[] headers, String rawJsonResponse, Object response){
//
//                Gson gson = new Gson();
...
//        APIHelperAsync.getHatcheryRecords("getHatcheryRecords/", new BaseJsonHttpResponseHandler<Object>() {
//            @Override
//            public void onSuccess(int statusCode, Header[] headers, String rawJsonResponse, Object response){
//
//                Gson gson = new Gson();
