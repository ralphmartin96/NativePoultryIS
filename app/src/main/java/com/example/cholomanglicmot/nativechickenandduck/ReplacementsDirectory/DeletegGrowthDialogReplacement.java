...
public class DeletegGrowthDialogReplacement extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final Integer feeding_id = getArguments().getInt("Replacement Growth ID");
        context = getActivity();
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isDeleted = myDb.deleteGrowthRecordReplacement(feeding_id);
                if(isDeleted){
