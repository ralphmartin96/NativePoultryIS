...
public class DeleteHatchery extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_delete_hatchery, container, false);
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isDeleted = myDb.deleteHatchery(feeding_id);
                if(isNetworkAvailable()){
                    ...
                    API_deleteHatchery(requestParams);
                }
                if(isDeleted){
                    Toast.makeText(getActivity(), "Succesfully deleted hatchery record", Toast.LENGTH_SHORT).show();
                    getDialog().dismiss();
    ...
    private void API_deleteHatchery(RequestParams requestParams){
        APIHelperAsync.deleteHatchery("deleteHatchery", requestParams, new BaseJsonHttpResponseHandler<Object>() {
            @Override
