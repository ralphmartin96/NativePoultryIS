...
public class CreateMortalityAndSalesBrooderDialog extends DialogFragment{
    ...
    MortalityFragmentBrooder mortFragment;

    SalesFragmentBrooder salesFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mortFragment = new MortalityFragmentBrooder();
        salesFragment = new SalesFragmentBrooder();
