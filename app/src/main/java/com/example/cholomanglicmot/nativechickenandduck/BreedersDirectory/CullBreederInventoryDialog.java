...
public class CullBreederInventoryDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final Integer brooder_pen = getArguments().getInt("Breeder Pen ID");
        final Integer brooder_id = getArguments().getInt("Breeder ID");
        context = getActivity();
        ...
        Cursor cursor1 = myDb.getAllDataFromBreederInventoryWhereID(brooder_id);
        cursor1.moveToFirst();
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isDeleted = myDb.cullBreederInventory(brooder_tag, date);
                if(isNetworkAvailable()){
                    ...
                    API_cullBreederInventory(requestParams);
                }
                //update brooder pen
                ...
                if(isDeleted){
                    Toast.makeText(getContext(), "Breeder "+brooder_tag+" deleted.", Toast.LENGTH_SHORT).show();
                }
...
//                Toast.makeText(getContext(), "Successfully edited pen count", Toast.LENGTH_SHORT).show();
    ...
    private void API_cullBreederInventory(RequestParams requestParams){
        APIHelperAsync.cullBreederInventory("cullBreederInventory", requestParams, new BaseJsonHttpResponseHandler<Object>() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, String rawJsonResponse, Object response){
